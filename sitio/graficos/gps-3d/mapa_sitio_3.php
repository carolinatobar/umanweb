				<div class="cc-divider">Posicionamiento 3D en faena</div>
<?php
	...
	<body>
		...
		<script>
			...
			function init() {
				...
				<?php
				$camino = "./graficos/gps-3d/camino_".$faena.".txt";
				...
				bordes.vertices.push(
					new THREE.Vector3(<?php $x = ((($xmin-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($ymin-300))/2); ?>, <?php $z = ((($zmin-$zmin)*50000 -700)/(-2)); print $z; ?>),
					new THREE.Vector3(<?php $x = ((($xmax-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($ymin-300))/2); ?>, <?php $z = ((($zmin-$zmin)*50000 -700)/(-2)); print $z; ?>),
					new THREE.Vector3(<?php $x = ((($xmax-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($ymin-300))/2); ?>, <?php $z = ((($zmax-$zmin)*50000 -700)/(-2)); print $z; ?>),
					new THREE.Vector3(<?php $x = ((($xmin-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($ymin-300))/2); ?>, <?php $z = ((($zmax-$zmin)*50000 -700)/(-2)); print $z; ?>),
					new THREE.Vector3(<?php $x = ((($xmin-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($ymin-300))/2); ?>, <?php $z = ((($zmin-$zmin)*50000 -700)/(-2)); print $z; ?>)
					);
				var lineash = new THREE.Line( bordes, material1 );
				scene.add( lineash );
