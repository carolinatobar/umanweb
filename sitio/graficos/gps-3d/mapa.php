...
$info = explode("/",file_get_contents("caminoinfo.txt"));
...
<html lang="en">
	...
	<body>
		...
		<script>
			...
			var container, stats, rotacion=0;
			var subida = true;
			var scale = 1;
			...
			function init() {
				...
				cube.position.y = <?php print (($ALTURA_inst-$ymin-300)/2); ?>;
				...
				$mapaString = file_get_contents('mapa_soldado.txt');
				...
				foreach ( $lineas as $linea ) {
				    ...
				    new THREE.Vector3( <?php $x = ((($x-$xmin)*50000 - 100)/(-2)); print $x; ?>, <?php print ((($y-$ymin-300))/2); ?>, <?php $z = ((($z-$zmin)*50000 -700)/(-2)); print $z; ?> )
    ...
    context1.fillText('Ch. Primario', 0, 50);
...
<?php /*
			...
			function actualizaDatos(str) {
				if (str == "") {
			    	...
			    	xmlhttp.open("GET","getdatos.php?equipo="+str,true);
			    	xmlhttp.send();
			    	xmlhttp.onreadystatechange = function() {
			      		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				        	...
				        	cube.position.y = (((objeto['ALTURA']-(<?php print $ymin; ?>)-300))/2);
...
<div style="position: fixed; color: black; top: 10px; width:100%; text-align: center; font-family: 'Libre Franklin', sans-serif; font-size: 30px">
FAENA EL SOLDADO</h1></div>
<div style="position: fixed; color: black; bottom: 30%; left: 10px; width: 300px">
Latitud: <div id="lat" style="color: yellow"><?php print $X_inst; ?></div><br>
Longitud: <div id="lon" style="color: yellow"><?php print $Y_inst; ?></div><br>
Altura: <div id="alt" style="color: yellow"><?php print $ALTURA_inst; ?> m</div><p>&nbsp;</p>
Rapidez: <div id="rap" style="color: yellow"><?php print $RAPIDEZ_inst; ?> km/h</div><br>
Pendiente: <div id="pendiente" style="color: yellow">0°</div><br>
<p>
</p>
</div>
...
<button onclick="window.location.href = '../../index.php'">Volver a monitoreo</button>&nbsp;&nbsp;&nbsp;
